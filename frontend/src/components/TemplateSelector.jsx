  ...
  const templates = [
    {
      ...
      name: "Classic",
      description:
        "A clean, and traditional resume layout with clean sections and professional typography.",
    },
    {
      id: "modern",
      name: "Modern",
        ...
        <div className="absolute top-full w-80 p-3 mt-2 space-y-3 z-10 bg-white rounded-md border border-gray-200 shadow-sm">
          {templates.map((template) => (
            <div
              ...
              className={`relative p-3 border rounded-md cursor-pointer transition-all ${selectedTemplate === template.id ? "bg-blue-100 border-blue-500" : "hover:border-gray-400 hover:bg-gray-100"}`}
            >
